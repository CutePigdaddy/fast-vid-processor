...
from .tasks import (
    text_task,  #type:ignore
    photo_task,   #type:ignore
    extract_audio_task, #type:ignore
    vocal_task, #type:ignore
    stt_task, #type:ignore
    app as celery_app
) 
text_task: Task = text_task
photo_task: Task = photo_task
extract_audio_task: Task = extract_audio_task
vocal_task: Task = vocal_task
stt_task: Task = stt_task
...
def download_file(task_id: str):
  ...
  file_path = task_result.get('output_file')[0]
